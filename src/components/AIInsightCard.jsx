      ...
      {!isPro && (
        <div className="mt-5 pt-4 border-t border-hairline">
          <p className="font-body text-[12px] text-text-muted italic leading-relaxed">
            This advice is generated by AI based on current market data. Always do your own research before making any investment decisions.
          </p>
        </div>
      )}
    </div>
