        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 border-t border-card-border pt-6">
          ...
          <div>
            ...
            <p className="font-body text-[12px] text-text-muted mt-2 leading-relaxed">
              {mode === 'beginner'
                ? (rsi >= 70
                    ? 'The price has gone up too fast recently. It might be slightly expensive right now.'
                    : rsi <= 30
                      ? 'The stock has been sold heavily. It might be cheap, but be careful.'
                      : 'The stock price is moving at a normal, healthy pace.')
                : (rsi >= 70
                    ? 'Elevated RSI suggests potential overvaluation. Consider trailing stop.'
                    : rsi <= 30
                      ? 'Low RSI indicates oversold conditions. Watch for reversal patterns.'
                      : 'RSI neutral range. No immediate momentum signal.')}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="font-body text-[12px] text-text-muted mt-2 leading-relaxed">
              {mode === 'beginner'
                ? (data.trend === 'up'
                    ? 'The stock is generally going up. Buyers are in control.'
                    : data.trend === 'down'
                      ? 'The stock is going down. Sellers are in control right now.'
                      : "The stock isn't moving much in either direction.")
                : (data.trend === 'up'
                    ? 'Consistent upward channel. MA crossover confirms bullish momentum.'
                    : data.trend === 'down'
                      ? 'Downward pressure with bearish MA alignment. Risk elevated.'
                      : 'Consolidation phase. Awaiting breakout confirmation.')}
            </p>
          </div>
