  ...
  return (
    <section className="py-32 lg:py-40" ref={sectionRef}>
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          Systematize Your<br />Investment Decisions.
        </motion.h2>
        <motion.p
        ...
        >
          Deploy InvestSense AI as your behavioral guardrail and navigate volatile market conditions with absolute clarity.
        </motion.p>
        <motion.div
