  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-3">
        <label htmlFor={inputId} className="block font-mono text-[10px] text-text-muted uppercase tracking-[2px]">{label}</label>
        {error && <span className="font-mono text-[10px] text-danger tracking-[1px] uppercase" id={errorId} role="alert">{error}</span>}
      </div>
