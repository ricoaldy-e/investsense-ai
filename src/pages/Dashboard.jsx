...
const Dashboard = () => {
  ...
  const handleToggleWatchlist = useCallback(async () => {
    ...
    try {
      ...
      if (err.response?.status === 409) setIsInWatchlist(true);
    ...
    return (
      <div className="pb-24 md:pb-0 flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <p className="font-body text-[14px] text-text-secondary text-center max-w-md leading-relaxed mb-8">
          Awaiting input. Search a stock ticker in the bar above to generate a clinical-grade market analysis.
        </p>
      </div>
    );
  }
